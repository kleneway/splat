...
export const vignettes: Vignette[] = [
  {
    ...
    age: 8,
    setting: 'Hallway at night, soft guitar music drifting from the living room',
    story: [
      {
        speaker: "Roy",
    ...
    choices: [
      {
        ...
        description: 'Risk interrupting their private moment to share in his music',
  ...
  },
  {
    ...
    age: 12,
    setting: 'School nurse\'s office, sounds of presentations echoing from down the hall',
    story: [
      {
        speaker: "Roy",
  ...
  },
  {
    ...
    title: 'The Wall',
    age: 15,
    setting: 'Behind the school building, spray paint can cold in your trembling hand',
    story: [
      {
        speaker: "Roy",
    ...
    choices: [
      {
        ...
        description: 'Be honest about both the mistake and the attempt to fix it',
        effects: { integrity: 1, desire: 1 },
        type: 'risky',
      },
      {
    ...
    choices: [
      {
        ...
        description: 'Share your most vulnerable self with someone who might understand',
        effects: { desire: 1, integrity: 1 },
  ...
  },
  {
    ...
    age: 20,
    setting: 'Downtown square, the acrid smell of tear gas beginning to drift through the crowd',
    story: [
      {
        speaker: "Roy",
  ...
  },
  {
    ...
    title: 'Two Doors',
    age: 24,
    setting: 'Corporate office with floor-to-ceiling windows overlooking distant mountains',
    story: [
      {
        speaker: "Roy",
  ...
  },
  {
    ...
    age: 27,
    setting: 'Kitchen table at dawn, coffee growing cold between trembling hands',
    story: [
      {
        speaker: "Roy",
